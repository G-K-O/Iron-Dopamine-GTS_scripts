...
[infolder_list,outfolder_list] = Get_IO_Directory_Lists('GTS');

voxelsize = [0.8,0.8,0.8]; 
N = [266, 266,176,9];
TE_ms = [5,9.1,13.2,17.3,21.4];


for i = 20:length(infolder_list(:,1)) %start with n-2 cause 10 and 13 are missing (were unusable)
